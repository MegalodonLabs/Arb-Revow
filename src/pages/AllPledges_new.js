...
const AllPledges = () => {
  ...
  useEffect(() => {
    const fetchPledges = async () => {
      try {
        ...
        console.log('Todos os pledges:', allPledges);
        setPledges(allPledges);
      } catch (err) {
        console.error('Erro ao buscar pledges:', err);
        setError('Erro ao buscar pledges. Por favor, tente novamente.');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Todos os Pledges</h1>
      ...
      {loading ? (
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <p className="text-gray-500 mb-6">Ainda não há pledges registrados no sistema.</p>
            ...
            <div key={index} className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="mb-3">
                    <p className="text-xs text-gray-500 uppercase font-semibold">Endereço do Pledgor</p>
